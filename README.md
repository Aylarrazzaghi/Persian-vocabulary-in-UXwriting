...
| بجای حساب کاربری،‌ گاهی می‌توانیم  از ترکیب اسم «برند» + «من» استفاده کنیم، مانند «دیجی‌کالای من». در این حالت باید بدانیم که گاهی هنگام راهنمایی کاربر  و استفاده از ضمایر دچار مشکل می‌شویم، مثال: «سفارش‌های شما» در «دیجی‌کالای من» است  | حساب کاربری  | Profile |
|   | ثبت‌نام / عضویت | Sign up |  
|  | ورود | Log in |  
