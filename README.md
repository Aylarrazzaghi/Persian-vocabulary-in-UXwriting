...
| در حقیقت حساب کاربری معادل «account» است. «پروفایل» یک بخش از حساب کاربری و معادل فارسی آن «نمایه» است اما واژه آشنایی نیست. در بیشتر محصولات، معمولا حساب کاربری و پروفایل، در حقیقت یکی هستند و تمام تنظیمات «account» از طریق «Profile» یا همان حساب کاربری در دسترس است. تجربه من نشان داده که برای هر دو مفهوم می‌توانیم از حساب کاربری استفاده کنیم. اگر در یک محصول، بروفایل کاملا از حساب کاربری جدا بود، می‌توانیم  از ترکیب اسم «برند» + «من» استفاده کنیم، مانند «دیجی‌کالای من». در این حالت باید بدانیم که گاهی هنگام راهنمایی کاربر  و استفاده از ضمایر دچار مشکل می‌شویم، مثال: «سفارش‌های شما» در «دیجی‌کالای من» است  | حساب کاربری  | Profile |
