...
| ------------- | ------------- | -------------|
| | |  پیام‌ها / پیام | inbox | 
| | | واژه نوتیفیکیشن برای افرادی که از زبان انگلیسی برای گوشی خود استفاده می‌کنند، آشناتر است. اما افرادی که گوشی خود را روی زبان فارسی تنظیم کرده‌آند، با واژه (اعلان) آشناتر هستند. گاهی بهتر است از ترکیب «اعلان (نوتیفیکیشن)» در کنار هم استفاده کنیم.  | اعلان / نوتیفیکیشن | Notification | 
