...
| افرادی که از زبان انگلیسی برای گوشی استفاده می‌کنند، با واژه «نوتیفیکیشن» آشناتر هستند. اما افرادی که از زبان فراسی استفاده می‌کنند، واژه «اعلان» را بیشتر می‌شناسند. گاهی نیز می‌توانیم از ترکیب «اعلان (نویتیفیکیشن» استفاده کنیم. | اعلان‌ها /اعلان/ فعالیت‌ها | Notifications |
