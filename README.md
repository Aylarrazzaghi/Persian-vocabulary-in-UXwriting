...
| واژه «رایانامه» پیشنهاد فرهنگستان است اما برای کاربران جا نیفتاده و آشنا نیست. شاید بهتر باشد در این مورد خاص، از همان «ایمیل» استفاده کنیم  | رایانامه / پست الکترونیک | Email |  
|  | حریم خصوصی | Privacy |  
...
| همیشه باید به هدف دکمه اشاره کنیم، اگر با زدن دکمه کاربر می‌تواند جزئیات بیشتری ببیند، متن دکمه را به «جزئیات بیشتر» تغییر دهیم. یا اگر با زدن دکمه کاربر می‌تواند ادامه مطلب را بخواند، متن دکمه را «مطالعه بیشتر» یا «ادامه مطلب» تغییر دهیم | مشاهده/ تماشا/ نمایش | See / View | 
|  | بعدی | Next | 
|  | قبلی | Previous | 
